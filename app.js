...
document.addEventListener("pointerdown", (event) => {
  ...
  button.style.setProperty("--touch-x", event.clientX - rect.left + "px");
  button.style.setProperty("--touch-y", event.clientY - rect.top + "px");
});
...
document.querySelectorAll("[data-route]").forEach((b) =>
  b.addEventListener("click", () => {
    ...
    journeyDrift = b.dataset.route === "56" ? -1 : 1;
...
document.querySelectorAll("[data-direction]").forEach((b) =>
  b.addEventListener("click", () => {
    ...
    journeyDrift = b.dataset.direction === "out" ? -1 : 1;
