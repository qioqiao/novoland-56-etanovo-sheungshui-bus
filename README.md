...
每次完整開啟或重新載入頁面時，P5R 使用紅黑斜切色板帶出箭頭 Logo，Logo 短暫定格後縮回左上角，主卡與行程區以完整位移及淡入依次就位，約 1.4 秒完成。Classic 使用原版 Logo 呼吸、縮回及柔和模糊入場。行程及風格切換不會重播開場；到站資料同時載入，不等待動畫。

點按、鍵盤操作、捲動、旋轉或切換背景會立即結束開場；「減少動態效果」直接顯示介面。動畫模組失敗時，頁面最多 2.6 秒後自動恢復。黑色卡片切換時的短暫掃光保留，改為窄白色斜向亮帶。時鐘及例行更新不重播整張卡。
